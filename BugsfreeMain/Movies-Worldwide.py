...
class M3UCollector:
    ...
    def export_m3u(self, filename="Worldwide-Movies.m3u"):
    ...
    def export_txt(self, filename="Worldwide-Movies.txt"):
        filepath = os.path.join(self.output_dir, filename)
        with open(filepath, 'w', encoding='utf-8') as f:
    ...
    def export_json(self, filename="Worldwide-Movies.json"):
        filepath = os.path.join(self.output_dir, filename)
    ...
    def export_custom(self, filename="Worldwide-Movies"):
...
def main():
    ...
    # Export files
    collector.export_m3u("Worldwide-Movies.m3u")
    collector.export_txt("Worldwide-Movies.txt")
    collector.export_json("Worldwide-Movies.json")
    collector.export_custom("Worldwide-Movies")
